...
#define WITH_FISHER true
  ...
  public:
    ...
    static AxisAlignedFeatureResponse CreateRandom(Random& random, const IDataPointCollection& data, unsigned int* dataIndices, const unsigned int i0, const unsigned int i1,float svm_c, std::vector<int>& partitions, std::vector<char>& partition_types, std::vector<int>& partition_lengths, bool root_node);
  ...
  public:
    ...
    static LinearFeatureResponse2d CreateRandom(Random& random, const IDataPointCollection& data, unsigned int* dataIndices, const unsigned int i0, const unsigned int i1,float svm_c, std::vector<int>& partitions, std::vector<char>& partition_types,std::vector<int>& partition_lengths,  bool root_node);
  ...
  public:
      ...
      /// <param name="randomNumberGenerator">A random number generator.</param>
      /// <returns>A new LinearFeatureResponse2d instance.</returns>
      static LinearFeatureResponse CreateRandom(Random& random, const IDataPointCollection& data, unsigned int* dataIndices, const unsigned int i0, const unsigned int i1,float svm_c, std::vector<int>& partitions, std::vector<char>& partition_types,std::vector<int>& partition_lengths,  bool root_node);
  ...
  public:
      ...
      static LinearFeatureResponseSVM CreateRandom(Random& random, const IDataPointCollection& data, unsigned int* dataIndices, const unsigned int i0, const unsigned int i1,float svm_c, std::vector<int>& partitions, std::vector<char>& partition_types,std::vector<int>& partition_lengths,  bool root_node);
      ...
      static void GenerateMaskGrouped(Random &random, std::vector<int> &vIndex, int start, int end, bool root_node);
      static void GenerateMaskChoiced(Random &random, std::vector<int> &vIndex, int start, int end, int max, bool root_node);
      static void GenerateMaskStatistics(Random &random, std::vector<int> &vIndex, int start, int end, int max, bool root_node);
