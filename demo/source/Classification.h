...
namespace MicrosoftResearch { namespace Cambridge { namespace Sherwood
{
  ...
  {
  public:
    virtual F CreateRandom(Random& random, const IDataPointCollection& data, unsigned int* dataIndices, const unsigned int i0, const unsigned int i1,float svm_c, std::vector<int>& partitions, std::vector<char>& partition_types, std::vector<int>& partition_lengths,  bool root_node)=0;
  };

  class LinearFeatureFactory: public IFeatureResponseFactory<LinearFeatureResponse>
  {
  public:
      LinearFeatureResponse CreateRandom(Random& random, const IDataPointCollection& data, unsigned int* dataIndices, const unsigned int i0, const unsigned int i1,float svm_c, std::vector<int>& partitions, std::vector<char>& partition_types, std::vector<int>& partition_lengths,  bool root_node);
  };
  ...
  {
  public:
      AxisAlignedFeatureResponse CreateRandom(Random& random, const IDataPointCollection& data, unsigned int* dataIndices, const unsigned int i0, const unsigned int i1,float svm_c, std::vector<int>& partitions, std::vector<char>& partition_types,std::vector<int>& partition_lengths,  bool root_node);
  };

  class LinearFeatureSVMFactory: public IFeatureResponseFactory<LinearFeatureResponseSVM>
  {
  public:
      LinearFeatureResponseSVM CreateRandom(Random& random, const IDataPointCollection& data, unsigned int* dataIndices, const unsigned int i0, const unsigned int i1,float svm_c, std::vector<int>& partitions, std::vector<char>& partition_types,std::vector<int>& partition_lengths,  bool root_node);
  };
  ...
  private:
    ...
    F GetRandomFeature(Random& random, const IDataPointCollection& data, unsigned int* dataIndices, const unsigned int i0, const unsigned int i1,float svm_c, std::vector<int>& partitions, std::vector<char>& partition_types,std::vector<int>& partition_lengths,  bool root_node)
    {
      return featureFactory_->CreateRandom(random, data, dataIndices,i0,i1,svm_c, partitions,partition_types,partition_lengths, root_node);
    }
  ...
  public:
    ...
    static void Test(const Forest<F, HistogramAggregator>& forest, const DataPointCollection& testData, std::vector<HistogramAggregator>& distributions) // where F : IFeatureResponse
    {
      ...
      for (int i = 0; i < testData.Count(); i++)
      {
        ...
        for (int t = 0; t < 10;t++)//forest.TreeCount(); t++)
        {
