...
//Change the random feature function if you want to use this
...
//Default stuff
  trainingParameters.data_partitions.push_back(32);
  trainingParameters.data_partition_types.push_back('R');
  trainingParameters.data_partitions.push_back(32);
  trainingParameters.data_partition_types.push_back('G');
  trainingParameters.data_partition_lengths.push_back(32);
  trainingParameters.data_partition_lengths.push_back(32);
