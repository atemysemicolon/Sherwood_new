...
namespace MicrosoftResearch { namespace Cambridge { namespace Sherwood
{
  ...
  public:
    ...
    /// </summary>
    virtual F GetRandomFeature(Random& random, const IDataPointCollection& data, unsigned int* dataIndices, const unsigned int i0, const unsigned int i1,float svm_c, std::vector<int>& partitions, std::vector<char>& partition_types,std::vector<int>& partition_lengths,  bool root_node=false) = 0;
    //virtual F GetRandomOrganizedFeature(Random& random, const IDataPointCollection& data, unsigned int* dataIndices, const unsigned int i0, const unsigned int i1,float svm_c, std::vector<int>& partitions, std::vector<char>& partition_types, bool root_node=false) = 0;
